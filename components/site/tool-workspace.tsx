    ...
    <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
      <div className="glass-panel p-6 sm:p-7">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm leading-7 text-muted">
              Frontend-only simulation keeps the page stable while still feeling like a real Filevia product flow.
            </p>
          </div>
        ...
        >
          ...
          <p className="mt-2 max-w-sm text-sm leading-6 text-muted">
            Accepts {tool.accepts}. Click to browse, then run a preview of the workflow.
          </p>
        </button>
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button type="button" className="primary-button" onClick={triggerPreview}>
      ...
      <div className="glass-panel p-6 sm:p-7">
        ...
        <div className="mt-6 rounded-[28px] border border-white/10 bg-[#09131D] p-5">
          <div className="flex min-h-[220px] flex-col justify-between rounded-[24px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.02))] p-5">
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-muted">
                {files.length
                  ? "This area represents the processed output preview and keeps the interaction feeling grounded in a real product."
                  : "Choose files to populate the preview area with a realistic processing state."}
              </p>
            </div>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          {tool.stats.map((stat) => (
            <div key={stat} className="rounded-2xl border border-white/10 bg-white/5 px-4 py-4">
              ...
              <p className="mt-2 text-xs leading-5 text-muted">Part of the simulated Filevia workflow for this tool.</p>
            </div>
          ))}
        </div>
      </div>
